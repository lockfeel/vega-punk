...
class DBase:
    ...
    def _initBots(self):
        bots = [
            ...
            ("dispatching-parallel-agents", "并行大师", "https://res.amemo.cn/dispatching-parallel-agents.png"),
            ("docx", "文档匠人", "https://res.amemo.cn/docx.png"),
            ("executing-plans", "执行星使", "https://res.amemo.cn/executing-plans.png"),
            ("find-skills", "技能探知", "https://res.amemo.cn/find-skills.png"),
            ("finishing-a-development-branch", "分支卫士", "https://res.amemo.cn/finishing-a-development-branch.png"),
            ...
            ("planning-with-json", "规划谋士", "https://res.amemo.cn/planning-with-json.png"),
            ("pptx", "演示大师", "https://res.amemo.cn/pptx.png"),
            ("receiving-code-review", "评审接引人", "https://res.amemo.cn/receiving-code-review.png"),
            ("requesting-code-review", "审阅使", "https://res.amemo.cn/requesting-code-review.png"),
            ...
            ("subagent-driven-development", "子代理官", "https://res.amemo.cn/subagent-driven-development.png"),
            ("systematic-debugging", "系统调试师", "https://res.amemo.cn/systematic-debugging.png"),
            ("test-driven-development", "测试驱动者", "https://res.amemo.cn/test-driven-development.png"),
            ("theme-factory", "主题工厂", "https://res.amemo.cn/theme-factory.png"),
            ("ui-ux-pro-max", "UI/UX极客", "https://res.amemo.cn/ui-ux-pro-max.png"),
            ("using-git-worktrees", "枝干大师", "https://res.amemo.cn/using-git-worktrees.png"),
            ("vega-punk", "慎思者", "https://res.amemo.cn/vega-punk.png"),
            ("verification-before-completion", "验核先锋", "https://res.amemo.cn/verification-before-completion.png"),
